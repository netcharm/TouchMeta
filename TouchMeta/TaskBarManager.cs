...
namespace Common
{
    ...
    /// https://www.cnblogs.com/crwy/p/10091034.html
    /// </summary>
    public static class TaskbarManager
    {
        ...
        private static double MaximumValue { get; set; } = 100;
        ...
        public static void SetProgressValue(int currentValue, int maximumValue)
        {
            if (IsPlatformSupported && ownerHandle != IntPtr.Zero)
            {
                ...
                TaskbarList.Instance.SetProgressValue(
                    ...
                    Math.Max(Convert.ToUInt32(currentValue), Convert.ToUInt32(maximumValue)));
            }
        }
        ...
        public static void SetProgressValue(double currentValue, double maximumValue)
        {
            MaximumValue = maximumValue;
            SetProgressValue(Convert.ToInt32(currentValue), Convert.ToInt32(maximumValue));
        }
        ...
        /// <param name="currentValue"></param>
        /// <param name="maximumValue"></param>
        public static void SetProgressValue<T>(T currentValue, T maximumValue)// where T: int, uint,  long, ulong, double
        {
            if ((currentValue is double || currentValue is int || currentValue is long || currentValue is uint || currentValue is ulong) &&
                (maximumValue is double || maximumValue is int || maximumValue is long || maximumValue is uint || maximumValue is ulong))
            {
                MaximumValue = Convert.ToDouble(maximumValue);
                SetProgressValue(Convert.ToInt32(currentValue), Convert.ToInt32(maximumValue));
            }
        }
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="currentValue"></param>
        public static void SetProgressValue<T>(T currentValue)
        {
            if ((currentValue is double || currentValue is int || currentValue is long || currentValue is uint || currentValue is ulong))
            {
                SetProgressValue(Convert.ToInt32(currentValue), Convert.ToInt32(MaximumValue));
        ...
        /// 
        /// </summary>
        public static void SetProgressError()
        {
        ...
        /// 
        /// </summary>
        public static void SetProgressIndeterminate()
        {
        ...
        /// 
        /// </summary>
        public static void SetProgressNone()
        {
        ...
        /// 
        /// </summary>
        public static void SetProgressNormal()
        {
        ...
        /// 
        /// </summary>
        public static void SetProgressPaused()
        {
        ...
        /// <param name="currentValue"></param>
        /// <param name="maximumValue"></param>
        public static void ResetProgress<T>(T currentValue, T maximumValue)
        {
            SetProgressNone();
